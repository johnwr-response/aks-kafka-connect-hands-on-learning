...
import no.responseweb.kafka.model.PullRequest;
import no.responseweb.kafka.model.User;
import no.responseweb.kafka.utils.DateUtils;
import no.responseweb.kafka.utils.VersionUtil;
...
public class GitHubSourceTask extends SourceTask {
    ...
    public List<SourceRecord> poll() throws InterruptedException {
        ...
        if (i > 0) log.info("Fetched {} record(s)", i);
        if (i == 100){
